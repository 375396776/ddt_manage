...
public class FMBankRSA {
	...
	public static Map<String, String> generateKeyPair() throws Exception {
		...
		String pub = new String(FMBankBase64.encodeBase64(publicKeyBytes),
				CHAR_ENCODING);
		/** 得到私钥 */
		Key privateKey = kp.getPrivate();
		byte[] privateKeyBytes = privateKey.getEncoded();
		String pri = new String(FMBankBase64.encodeBase64(privateKeyBytes),
				CHAR_ENCODING);
		...
		byte[] deBase64Value = FMBankBase64.encodeBase64(b);
	...
	public static String encrypt(String source, String publicKey)
		...
		return new String(FMBankBase64.encodeBase64(b1),
				CHAR_ENCODING);
	}
    /**
     * 加密方法 source： 源数据
	...
	public static String decrypt(String cryptograph, PrivateKey privateKey)
		...
		byte[] b1 = FMBankBase64.decodeBase64(cryptograph.getBytes());
		/** 执行解密操作 */
	...
	public static PublicKey getPublicKey(String key) throws Exception {
		X509EncodedKeySpec keySpec = new X509EncodedKeySpec(
				FMBankBase64.decodeBase64(key.getBytes()));
	...
	public static String sign(String content, String privateKey) {
		...
		try {
			PKCS8EncodedKeySpec priPKCS8 = new PKCS8EncodedKeySpec(
					FMBankBase64.decodeBase64(privateKey.getBytes()));
			...
			return new String(FMBankBase64.encodeBase64(signed));
		} catch (Exception e) {
	...
	public static boolean checkSign(String content, String sign, String publicKey)
	{
		...
		{
			KeyFactory keyFactory = KeyFactory.getInstance("RSA");
	        byte[] encodedKey = FMBankBase64.decode2(publicKey);
			...
			boolean bverify = signature.verify( FMBankBase64.decode2(sign) );
			return bverify;
